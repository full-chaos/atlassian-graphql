...
func (c *JiraRESTClient) ListIssueChangelogViaREST(ctx context.Context, issueKey string, pageSize int) ([]canonical.JiraChangelogEvent, error) {
	...
	var out []canonical.JiraChangelogEvent
